...
export const GPT_IMAGE_25_MODELS = ["gpt-image-2.5-sunburst", "gpt-image-2.5-flare", "gpt-image-2.5"] as const
export const GPT_IMAGE_MODELS = ["gpt-image-2", ...GPT_IMAGE_25_MODELS] as const
export const IMAGE_MODELS = [...GPT_IMAGE_MODELS, "gpt-5.6-luna"] as const
